...
public class TestVolumeSnapshotParser {
    @SneakyThrows
    private CloudTemplate getCloudTemplate(){
        CloudTemplate cloudTemplate = CloudTemplateFactory.getTemplate("aliyun","1.0",  "volumeSnapshot");
    ...
    @Test
    @SneakyThrows
    public void parseGetVolumeSnapshot(){
