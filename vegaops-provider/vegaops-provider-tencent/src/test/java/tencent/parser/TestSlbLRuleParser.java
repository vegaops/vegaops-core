...
public class TestSlbLRuleParser {
    @SneakyThrows
    private CloudTemplate getCloudTemplate(){
        CloudTemplate cloudTemplate = CloudTemplateFactory.getTemplate("tencent","1.0", "slbRule");
    ...
    public void parseGetVolumeList(){
        ...
        cloudTemplate.getVariables().put("load_balancer_id","lb-o56cui0x");
