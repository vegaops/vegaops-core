...
import org.prophetech.hyperone.vegaops.engine.proxy.Proxy;
import org.prophetech.hyperone.vegaops.engine.utils.DateUtils;
...
public final class FastBeanCopier {
    ...
    public static <T, S> T copy(S source, T target, Converter converter, String... ignore) {
        return copy(source, target, converter, (ignore == null || ignore.length == 0) ? new HashSet<>() : new HashSet<>(Arrays.asList(ignore)));
    }
    ...
    public static Copier createCopier(Class source, Class target) {
        ...
        String method = "public void copy(Object s, Object t, java.util.Set ignore, " +
                "org.prophetech.hyperone.vegaops.engine.bean.Converter converter){\n" +
                "try{\n\t" +
    ...
    static abstract class ClassProperty {
        ...
        public BiFunction<Class, Class, String> createGetterFunction() {
            ...
            return (targetBeanType, targetType) -> {
                ...
                String generic = "org.prophetech.hyperone.vegaops.engine.bean.FastBeanCopier.EMPTY_CLASS_ARRAY";
        ...
        public <T> T convert(Object source, Class<T> targetClass, Class[] genericType) {
            ...
            if (targetClass == String.class) {
                if (source instanceof Date) {
                    return (T) DateFormatUtils.format(((Date) source), "yyyy-MM-dd HH:mm:ss");
                }
            ...
            if (targetClass == Date.class) {
                if (source instanceof String) {
                    return (T) DateUtils .parse((String) source);
                }
